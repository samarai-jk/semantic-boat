...
// Forward declare a tiny C shim implemented in C++ to notify the UI driver
...
void PendSV_Handler(void)
{
  ...
  // Service deferred tasks and timers at lowest priority
  extern void app_executor_pendsv_service(void);
...
void EXTI4_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(BTN_TOGGLE_Pin);
